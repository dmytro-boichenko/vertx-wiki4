...
This project is a fourth part of https://vertx.io/docs/guide-for-java-devs/#_client_side_web_application_using_angularjs/[A gentle guide to asynchronous programming with Eclipse Vert.x for Java developers].
